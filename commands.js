...
const OWNER_JID = '6285820010137@s.whatsapp.net'; // contoh: 6281234567890@s.whatsapp.net
...
async function handleCommand(command, sock, msg, args, getScanState, setScanState) {
  ...
  switch (command) {
    ...
    case '.foundmalay': {
      ...
      const preview = await getFoundListBySharerPrefix("+60");
      ...
      await sock.sendMessage(senderGroupId, { text: generateGroupListBox("🇲🇾 GRUP MALAYSIA", list) }, { quoted: msg });
    ...
    case '.foundindo': {
      ...
      const preview = await getFoundListBySharerPrefix("+62");
      ...
      await sock.sendMessage(senderGroupId, { text: generateGroupListBox("🇮🇩 GRUP INDONESIA", list) }, { quoted: msg });
